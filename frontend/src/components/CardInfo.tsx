...
const CardInfo = () => {
  ...
  return (
    <section className="p-8 md:bg-white rounded-lg w-[21.8125rem] absolute top-[8rem] md:top-[14rem] left-[50%] -translate-x-[50%] z-50 flex flex-col gap-y-4 items-center md:card-wrapper">
